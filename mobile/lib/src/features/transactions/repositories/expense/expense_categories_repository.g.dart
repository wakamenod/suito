...
part of 'expense_categories_repository.dart';
...
final expenseCategoriesRepositoryProvider =
    Provider<ExpenseCategoriesRepository>.internal(
  expenseCategoriesRepository,
  name: r'expenseCategoriesRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$expenseCategoriesRepositoryHash,
  dependencies: null,
...
final expenseCategoriesListFutureProvider =
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$expenseCategoriesListFutureHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final expenseCategoriesMapFutureProvider =
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$expenseCategoriesMapFutureHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
