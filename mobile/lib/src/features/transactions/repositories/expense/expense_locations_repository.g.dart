...
part of 'expense_locations_repository.dart';
...
final expenseLocationsRepositoryProvider =
    Provider<ExpenseLocationsRepository>.internal(
  expenseLocationsRepository,
  name: r'expenseLocationsRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$expenseLocationsRepositoryHash,
  dependencies: null,
...
final expenseLocationsListFutureProvider =
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$expenseLocationsListFutureHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
