...
class SchedulesIncomeListItem extends ConsumerWidget {
  final TransactionSchedule item;

  const SchedulesIncomeListItem({super.key, required this.item});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CustomDismissible(
      ...
      child: GestureDetector(
        onTap: () => navigator.goFetchIncomeSchedule(item.id),
        child: Container(
          color: Colors.white,
          child: SizedBox(
            height: 50,
