...
class SuitoTransactionsApi {
  ...
  const SuitoTransactionsApi(this._dio, this._serializers);
  ...
  Future<Response<ListTransactionsRes>> listTransactions({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'yearMonth': encodeQueryParameter(_serializers, yearMonth, const FullType(String)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TransactionMonthsRes] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TransactionMonthsRes>> transactionMonths({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/transactions/months';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TransactionMonthsRes _responseData;

    try {
      const _responseType = FullType(TransactionMonthsRes);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as TransactionMonthsRes;
    ...
    return Response<TransactionMonthsRes>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
