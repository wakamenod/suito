...
class SuitoExpenseScheduleApi {

  final Dio _dio;

  final Serializers _serializers;

  const SuitoExpenseScheduleApi(this._dio, this._serializers);

  /// Delete expense schedule
  /// 支出スケジュール情報を削除します
  ///
  /// Parameters:
  /// * [request] - delete expenseSchedule req
  ...
  Future<Response<JsonObject>> deleteExpenseSchedule({ 
    required DeleteExpenseScheduleReq request,
    ...
    try {
      const _type = FullType(DeleteExpenseScheduleReq);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ExpenseScheduleDetailRes] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ExpenseScheduleDetailRes>> expenseScheduleDetail({ 
    required ExpenseScheduleDetailReq request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/expense-schedule/detail';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ExpenseScheduleDetailReq);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
    ...
    ExpenseScheduleDetailRes _responseData;

    try {
      const _responseType = FullType(ExpenseScheduleDetailRes);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ExpenseScheduleDetailRes;
  ...
  ///
  /// Parameters:
  /// * [request] - update expenseSchedule req
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateExpenseScheduleRes] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateExpenseScheduleRes>> updateExpenseSchedule({ 
    required UpdateExpenseScheduleReq request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateExpenseScheduleReq);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
    ...
    UpdateExpenseScheduleRes _responseData;

    try {
      const _responseType = FullType(UpdateExpenseScheduleRes);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UpdateExpenseScheduleRes;
    ...
    return Response<UpdateExpenseScheduleRes>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
