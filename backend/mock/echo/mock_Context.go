...
func (_m *MockContext) Attachment(file string, name string) error {
...
func (_m *MockContext) Bind(i interface{}) error {
	ret := _m.Called(i)
...
func (_m *MockContext) Blob(code int, contentType string, b []byte) error {
...
func (_m *MockContext) Cookie(name string) (*http.Cookie, error) {
	ret := _m.Called(name)
...
func (_m *MockContext) Echo() *echo.Echo {
	ret := _m.Called()
...
func (_m *MockContext) File(file string) error {
	ret := _m.Called(file)
...
func (_m *MockContext) FormParams() (url.Values, error) {
	ret := _m.Called()
...
func (_m *MockContext) FormValue(name string) string {
	ret := _m.Called(name)
...
func (_m *MockContext) HTML(code int, html string) error {
...
func (_m *MockContext) HTMLBlob(code int, b []byte) error {
...
func (_m *MockContext) Handler() echo.HandlerFunc {
	ret := _m.Called()
...
func (_m *MockContext) Inline(file string, name string) error {
	ret := _m.Called(file, name)
...
func (_m *MockContext) IsTLS() bool {
	ret := _m.Called()
...
func (_m *MockContext) JSON(code int, i interface{}) error {
...
func (_m *MockContext) JSONBlob(code int, b []byte) error {
	ret := _m.Called(code, b)
...
func (_m *MockContext) JSONP(code int, callback string, i interface{}) error {
...
func (_m *MockContext) JSONPBlob(code int, callback string, b []byte) error {
...
func (_m *MockContext) JSONPretty(code int, i interface{}, indent string) error {
...
func (_m *MockContext) Logger() echo.Logger {
	ret := _m.Called()
...
func (_m *MockContext) NoContent(code int) error {
	ret := _m.Called(code)
...
func (_m *MockContext) ParamNames() []string {
	ret := _m.Called()
...
func (_m *MockContext) ParamValues() []string {
	ret := _m.Called()
...
func (_m *MockContext) QueryParam(name string) string {
	ret := _m.Called(name)
...
func (_m *MockContext) QueryParams() url.Values {
	ret := _m.Called()
...
func (_m *MockContext) QueryString() string {
	ret := _m.Called()
...
func (_m *MockContext) RealIP() string {
	ret := _m.Called()
...
func (_m *MockContext) Redirect(code int, _a1 string) error {
...
func (_m *MockContext) Render(code int, name string, data interface{}) error {
...
func (_m *MockContext) Reset(r *http.Request, w http.ResponseWriter) {
	_m.Called(r, w)
}

// Response provides a mock function with given fields:
func (_m *MockContext) Response() *echo.Response {
	ret := _m.Called()
...
func (_m *MockContext) Scheme() string {
	ret := _m.Called()
...
func (_m *MockContext) SetCookie(cookie *http.Cookie) {
	_m.Called(cookie)
}

// SetHandler provides a mock function with given fields: h
func (_m *MockContext) SetHandler(h echo.HandlerFunc) {
	_m.Called(h)
}

// SetLogger provides a mock function with given fields: l
func (_m *MockContext) SetLogger(l echo.Logger) {
	_m.Called(l)
}

// SetParamNames provides a mock function with given fields: names
func (_m *MockContext) SetParamNames(names ...string) {
...
func (_m *MockContext) SetParamValues(values ...string) {
...
func (_m *MockContext) SetPath(p string) {
	_m.Called(p)
}

// SetRequest provides a mock function with given fields: r
func (_m *MockContext) SetRequest(r *http.Request) {
	_m.Called(r)
}

// SetResponse provides a mock function with given fields: r
func (_m *MockContext) SetResponse(r *echo.Response) {
	_m.Called(r)
}

// Stream provides a mock function with given fields: code, contentType, r
func (_m *MockContext) Stream(code int, contentType string, r io.Reader) error {
...
func (_m *MockContext) String(code int, s string) error {
...
func (_m *MockContext) Validate(i interface{}) error {
	ret := _m.Called(i)
...
func (_m *MockContext) XML(code int, i interface{}) error {
	ret := _m.Called(code, i)
...
func (_m *MockContext) XMLBlob(code int, b []byte) error {
	ret := _m.Called(code, b)
...
func (_m *MockContext) XMLPretty(code int, i interface{}, indent string) error {
	ret := _m.Called(code, i, indent)
...
// NewMockContext creates a new instance of MockContext. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockContext(t testing.TB) *MockContext {
	mock := &MockContext{}
	mock.Mock.Test(t)
